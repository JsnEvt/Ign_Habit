...
export function HabitDay({ amountOfHabit = 0, amountComplete = 0, date, ...rest }: Props) {

  const amountAccomplishedPercentage = amountOfHabit > 0 ? generateProgressPercentage(amountOfHabit, amountComplete) : 0
